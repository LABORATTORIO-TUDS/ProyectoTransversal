...
public class vistaMenuPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMIListarInscripciones.setText("Listar Inscripciones por Alumno");
        jMIListarInscripciones.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMIListarInscripcionesActionPerformed(evt);
            }
        });
        jMConsultas.add(jMIListarInscripciones);
    ...
    private void jMIListarInscripcionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMIListarInscripcionesActionPerformed
        vistaListarInscripciones vistaListado = new vistaListarInscripciones();
        jDesktopPane1.add(vistaListado);
